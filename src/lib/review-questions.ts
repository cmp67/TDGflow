export interface ReviewQuestion {
  id: string
  text: string
  type: 'text' | 'date' | 'select' | 'stars' | 'sub_stars' | 'voice_text'
  placeholder?: string
  options?: string[]
}
...
const STAY_QUESTIONS: ReviewQuestion[] = [
  { id: 'overall_rating', text: 'Que nota geral você daria?', type: 'stars' },
  { id: 'sub_ratings', text: 'Avalie cada aspecto.', type: 'sub_stars' },
 ...
 * porquê. Fora de hotel, pula as sub-notas de quarto/comida/localização,
