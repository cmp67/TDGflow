...
-- mesmo padrão de agency_id nullable já usado na migration 020:
-- NULL = compartilhado com a rede toda (comportamento atual, sem quebra);
-- preenchido = privado daquela agência.
--
